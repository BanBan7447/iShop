...
public class LoaiSPAdapter_User2 extends RecyclerView.Adapter<LoaiSPAdapter_User2.ViewHolder>{
    private Context context;
    private ArrayList<LoaiSanPham> list;

    public LoaiSPAdapter_User2(Context context, ArrayList<LoaiSanPham> list) {
    ...
    @NonNull
    @Override
    public LoaiSPAdapter_User2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.ui_recy_select_product_type, parent, false);
